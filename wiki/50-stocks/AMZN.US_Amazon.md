...
- 业务：电商零售、第三方卖家平台、Prime、AWS、广告和物流。
- 行业/主题：云计算、AI 基础设施、数字广告、消费与电商。
- 常见风险：AWS 增速、资本开支回报、消费放缓、监管、科技股估值和组合相关性。
- 偏好周期：中长期看 AWS 与利润率；短线只在回踩或突破确认后参与。
...
- 高流动性平台股也不应在强势日后无条件追价，必须用回踩/突破条件约束。

## 检查清单倾向

| 检查项 ID | 模式 | 证据 |
| --- | --- | --- |
| WB-BUS-01 | 强项 | 物流、Prime、AWS 和广告生态具有规模优势。 |
| WB-RISK-01 | 中性 | 公司风险可控，但组合已有较高科技相关性。 |
