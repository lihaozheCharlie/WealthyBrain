...
# BRK.B.US Berkshire Hathaway Class B

## 快照

- 业务：保险、铁路、能源、制造服务零售、现金和股票投资组合。
- 行业/主题：价值复合器、保险浮存金、资产负债表防御、科技轮动替代。
- 常见风险：接班人执行、现金拖累、保险灾害赔付、工业和铁路周期。
- 偏好周期：中长期，适合作为组合压舱石。
...
- 组合层面需要补足相关性，而不是只买最强主题。

## 检查清单倾向

| 检查项 ID | 模式 | 证据 |
| --- | --- | --- |
| WB-FIN-01 | 强项 | 经营利润和现金储备强。 |
| WB-VAL-01 | 中性偏强 | 约 1.47 倍 2026Q1 账面价值，不是深度低估，但相对质量和防御性可接受。 |
| WB-RISK-01 | 强项 | 与 AI 芯片因子相关性较低，有利于组合风险控制；弱项是 Greg Abel 接班后的资本配置仍在验证期。 |
