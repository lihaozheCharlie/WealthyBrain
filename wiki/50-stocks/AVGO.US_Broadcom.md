...
- 业务：定制 AI 加速器、网络芯片、无线连接、基础设施软件和 VMware。
- 行业/主题：AI 数据中心、定制 ASIC、半导体、企业软件整合。
- 常见风险：AI 资本开支周期、客户集中、半导体估值压缩、VMware 整合、组合集中度。
- 偏好周期：中长期，适合财报和订单趋势跟踪。
...
- 高质量赢家也需要组合权重上限，否则单票波动会主导账户结果。

## 检查清单倾向

| 检查项 ID | 模式 | 证据 |
| --- | --- | --- |
| WB-BUS-01 | 强项 | 定制 AI 芯片、网络和 VMware 软件带来规模与客户黏性。 |
| WB-RISK-01 | 弱项 | 集中度和拥挤交易是比公司基本面更直接的风险。 |
