...
- 业务：Azure、Microsoft 365、Windows、GitHub、企业软件和 AI 平台。
- 行业/主题：云计算、企业软件、AI 应用、开发者生态。
- 常见风险：AI capex 回报、Azure 增速、监管、企业 IT 预算。
- 偏好周期：中长期，财报后验证更重要。
...
- 对亏损持仓加仓必须基于财报和估值，而不是单纯摊低成本。

## 检查清单倾向

| 检查项 ID | 模式 | 证据 |
| --- | --- | --- |
| WB-BUS-01 | 强项 | 企业软件和云生态黏性强。 |
| WB-RISK-01 | 中性 | AI capex 是核心争议，需要财报持续验证。 |
